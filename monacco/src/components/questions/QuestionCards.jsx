...
import {
    ...
    Box,  // Import Box from Chakra UI for layout
...
const QuestionGenerator = () => {
    ...
    const handleOptionChange = (index, key) => {
    ...
    const handleSubmit = () => {
        calculateTotalMarks();  // Calculate total score before submission
    ...
    const calculateTotalMarks = () => {
        ...
        selectedQuestions.mcq.forEach((question, index) => {
            if (selectedOptions[index] === question.answer) {
                score += 1; // Each MCQ is worth 1 mark
            }
        });
        setTotalScore(score);
    };
    ...
    return (
        <div className="p-4 max-w-xl mx-auto">
            ...
            {/*  Wrap the following elements to ensure proper layout */}
